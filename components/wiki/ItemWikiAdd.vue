      ...
      <div class="modal-card">
        <div class="modal-card-head has-background-dark ">
            <p  class="modal-card-title has-text-white is-size-5 has-text-weight-bold">
              <b-icon icon="wizard-hat" /> Wiki Add {{item.name}}</p>
                  ...
                  <div class="column is-two-thirds">
                      <div class="field-body">
                          <fieldset class="field">
                              ...
                              <p class="help">Use Parenthesis for variation or special notation like (extended) or (borderless)</p>
                          </fieldset>
                      </div>
                      <div class="field-body">
                          <fieldset class="field">
                              <label class="label">Image URL</label>
                              <input class="input" v-model="item.image" ref="imageURLInput" name="image_url" type="text" placeholder="Paste Image full https url to replace current image">
                              <p class="help">Paste Image full https url to replace current image</p>
                          </fieldset>
                      </div>
                      ...
                      <div class="field-body">
                          ...
                          <div class="field"  style="flex: 100; flex-grow: 100;">
                              ...
                              <SetSelector
                                  ...
                                  <p class="help">This also sets the set code</p>
                          </div>
                      ...
                      <div class="field-body">
                          <div class="field">
                              ...
                              <b-input type="input" :type="item.main_type == 'custom' ? 'text' : 'hidden'" name="main_type_custom" type="text" :value="item.main_type">

                              <b-select :type="item.main_type == 'custom' ? 'text' : 'hidden'" id="main_type" name="main_type" v-model="item.main_type">
                      ...
                      <fieldset class="field-body">
                          <div class="field"  style="flex: 10; flex-grow: 10;">
                              ...
                              <p class="help">Casting Cost, magic has symbols</p>
                          </div>
                          <div class="field" style="flex: 1;">
                              <label class="label">CMC</label>
                              <input class="input" name="cmc" type="text" v-model="item.cmc">
                              <p class="help">Total mana cost. 1uu = 3, 1ubr = 4, 1g = 2 </p>
                          </div>
                      </fieldset>
                  </div>
                  <div class="column">
                      <img alt="full item image" :src="item.image">
                  </div>
